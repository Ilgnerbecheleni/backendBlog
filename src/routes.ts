...
import likePostContrtoller from "./Controllers/Post/like/likePostcontroller";
import CreateCommentController from "./Controllers/Post/comment/CreateCommentController";
const router = Router()
...
router.post('/posts/:postId/like',isAutenticated, new likePostContrtoller().handle )
router.post('/posts/:postId/comment',isAutenticated, new CreateCommentController().handle )
